...
export function salvaProjeto3D(nome: string, cenaCanonica: CenaCanonicaEditor3D, idProjeto?: number): Promise<Projeto3DMinimoPersistido> {
    return NoraApi.RestPOST(EventosApiRest.POST.Projeto3D.salvar, { idProjeto, nome, cenaCanonica }, { mensagemErro: 'Não foi possível salvar o projeto.' });
};
