...
//     dados: DadosGenericosAcao;
//     svg: string;
//     opcoesExecucoes: OpcoesExecucao[];
//     readonly refPai: IRitualServico | IItem | IHabilidade;
//     dadosComportamentos: DadosComportamentosAcao;
//     // dadosModificadores: 
// }

// export interface IAcaoService extends IAcao {
//     readonly nomeExibicao: string;
//     readonly bloqueada: boolean;
//     processaDificuldades: () => boolean;
//     executaComOpcoes: (valoresSelecionados: GastaCustoProps) => void;
//     comportamentos: EmbrulhoComportamentoAcao;
//     dadosAcaoCustomizada?: DadosAcaoCustomizada;
//     modificadores: IModificadorService[];
// }
