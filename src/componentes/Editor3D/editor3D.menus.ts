export type ComandoMenuEditor3D = 'NOVO_PROJETO' | 'SALVAR_PROJETO_ATUAL' | 'SALVAR_NOVO_PROJETO' | 'ABRIR_PROJETO' | 'CRIAR_CAPA_ARTE' | 'ADD_CUBO' | 'ADD_CILINDRO' | 'NOVO_MESH' | 'CAPTURAR_ARTE_CAPA';
...
export const MENUS_EDITOR_3D: readonly MenuEditor3D[] = [
    {
        ...
        itens: [
            ...
            { rotulo: 'Criar Especial', itens: [{ rotulo: 'Capa de Arte', comando: 'CRIAR_CAPA_ARTE' }] },
        ],
    },
    {
        rotulo: 'Adicionar',
