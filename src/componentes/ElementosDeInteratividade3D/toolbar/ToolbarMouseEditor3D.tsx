...
import { obtemComandoInteracaoAtualEditor3D } from '../comandos/editor3D.comandos';
...
export function ToolbarMouseEditor3D() {
    ...
    const modoAtual = obtemComandoInteracaoAtualEditor3D(estado.modoAtual.tipo, estado.ferramentaMouse);
