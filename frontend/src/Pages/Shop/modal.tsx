...
const page = ({ onCreate }: { onCreate: (novoRitual: dadosItens) => void; }) => {
    ...
    const data: { id: number, dados: dadosItens }[] = [
        ...
        { id: 22, dados: { idTipoItem: 2, nomeItem: { nomePadrao: 'Vestimenta de Acrobacia Simples'}, peso: 3, categoria: 1, detalhesEquipamentos: { }, buffs: [ { idBuff: 1, nome: 'Ferramentas Simples', valor: 2, duracao: { idDuracao: 3, valor: 1 }, idTipoBuff: 1, } ], } },
        ...
        { id: 37, dados: { idTipoItem: 2, nomeItem: { nomePadrao: 'Vestimenta de Ocultista Simples'}, peso: 3, categoria: 1, detalhesEquipamentos: { }, buffs: [ { idBuff: 24, nome: 'Ferramentas Simples', valor: 2, duracao: { idDuracao: 3, valor: 1 }, idTipoBuff: 1, } ], } },
