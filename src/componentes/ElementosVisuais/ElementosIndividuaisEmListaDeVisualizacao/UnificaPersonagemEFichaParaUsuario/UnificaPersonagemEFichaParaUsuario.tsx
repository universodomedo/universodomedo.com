...
import { ClasseDto, EstadoPendenciaPersonagem, FichaDto, FichaPersonagemDto, FichaTemporariaDto, NivelDto, PAGINAS, PersonagemDto } from 'types-nora-api';
...
function ListagemPersonagensEFichasTemporariasUsuario__ItemFichaTemporaria({ fichaTemporaria }: { fichaTemporaria: FichaTemporariaDto }) {
    return (
        <ListagemPersonagensEFichasTemporariasUsuario__Molde
            destino={{ pagina: PAGINAS.fichas, query: { [QUERY_PARAMS.FICHA]: fichaTemporaria.ficha.id } }}
...
function ListagemPersonagensEFichasTemporariasUsuario__Molde({ destino, caminhoAvatar, nome, pendeciaUsuario, classe, nivel, tempoProximaSessaoPersonagem }: { destino: DestinoInput; caminhoAvatar?: string; nome: string; pendeciaUsuario?: EstadoPendenciaPersonagem | string; classe?: ClasseDto, nivel?: NivelDto, tempoProximaSessaoPersonagem?: string }) {
    return (
