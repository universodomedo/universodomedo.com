...
//             this.requisitoFicha = new RequisitoFicha((dados: RLJ_Ficha2) => {
//                 return dados.periciasPatentes.some(pericia =>
//                     pericia.idPericia === habilidadePericia.idPericia &&
//                     pericia.idPatente >= habilidadePericia.idPatente
//                 );
//             });
//         } else {
...
//                     execucoes.find(execucao => execucao.refTipoExecucao.id === 3)!.numeroAcoesAtuais++;
//                 })
//             }
//         }
//         ]),
...
//             dadosGenericosHabilidade: { nome: 'Bom de Briga', descricao: 'Suas Armas recebem 1 Ponto de Característica Bônus' }, fonteHabilidade: { fonte: 'Habilidade Especial', tipo: 'Classe' }, requisitoFicha: new RequisitoFicha((dados: RLJ_Ficha2) => {
//                 return dados.detalhes.idClasse === 2;
//             })
...
//         new HabilidadePassiva({
//             dadosGenericosHabilidade: { nome: 'O Melhor da Turma', descricao: 'Você recebe o Atributo da Perícia como Bônus da Perícia' }, fonteHabilidade: { fonte: 'Habilidade Especial', tipo: 'Classe' }, requisitoFicha: new RequisitoFicha((dados: RLJ_Ficha2) => {
//                 return dados.detalhes.idClasse === 3;
//             })
//         }).adicionarModificadores([
//             { nome: 'O Mais Ágil da Turma', idDuracao: 5, quantidadeDuracaoMaxima: 1, dadosComportamentos: { dadosComportamentoPassivo: [] }, dadosEfeitos: SingletonHelper.getInstance().pericias.filter(pericia => pericia.refAtributo.id === 1).map(pericia => ({ idLinhaEfeito: pericia.refLinhaEfeito.id, idTipoEfeito: 4, dadosValoresEfeitos: { valorBonusAdicional: atributos.find(atributo => atributo.refAtributo.id === pericia.refAtributo.id)!.valorTotal } })) },
//             { nome: 'O Mais Forte da Turma', idDuracao: 5, quantidadeDuracaoMaxima: 1, dadosComportamentos: { dadosComportamentoPassivo: [] }, dadosEfeitos: SingletonHelper.getInstance().pericias.filter(pericia => pericia.refAtributo.id === 2).map(pericia => ({ idLinhaEfeito: pericia.refLinhaEfeito.id, idTipoEfeito: 4, dadosValoresEfeitos: { valorBonusAdicional: atributos.find(atributo => atributo.refAtributo.id === pericia.refAtributo.id)!.valorTotal } })) },
//             { nome: 'O Mais Inteligente da Turma', idDuracao: 5, quantidadeDuracaoMaxima: 1, dadosComportamentos: { dadosComportamentoPassivo: [] }, dadosEfeitos: SingletonHelper.getInstance().pericias.filter(pericia => pericia.refAtributo.id === 3).map(pericia => ({ idLinhaEfeito: pericia.refLinhaEfeito.id, idTipoEfeito: 4, dadosValoresEfeitos: { valorBonusAdicional: atributos.find(atributo => atributo.refAtributo.id === pericia.refAtributo.id)!.valorTotal } })) },
//             { nome: 'O Mais Perspicaz da Turma', idDuracao: 5, quantidadeDuracaoMaxima: 1, dadosComportamentos: { dadosComportamentoPassivo: [] }, dadosEfeitos: SingletonHelper.getInstance().pericias.filter(pericia => pericia.refAtributo.id === 4).map(pericia => ({ idLinhaEfeito: pericia.refLinhaEfeito.id, idTipoEfeito: 4, dadosValoresEfeitos: { valorBonusAdicional: atributos.find(atributo => atributo.refAtributo.id === pericia.refAtributo.id)!.valorTotal } })) },
//             { nome: 'O Mais Vigoroso da Turma', idDuracao: 5, quantidadeDuracaoMaxima: 1, dadosComportamentos: { dadosComportamentoPassivo: [] }, dadosEfeitos: SingletonHelper.getInstance().pericias.filter(pericia => pericia.refAtributo.id === 5).map(pericia => ({ idLinhaEfeito: pericia.refLinhaEfeito.id, idTipoEfeito: 4, dadosValoresEfeitos: { valorBonusAdicional: atributos.find(atributo => atributo.refAtributo.id === pericia.refAtributo.id)!.valorTotal } })) },
//         ]),

//         new HabilidadePassiva({
//             dadosGenericosHabilidade: { nome: 'Constituição Paranormal', descricao: 'Você recebe sua P.OCUL como Redução de Gasto de P.E. em Rituais' }, fonteHabilidade: { fonte: 'Habilidade Especial', tipo: 'Classe' }, requisitoFicha: new RequisitoFicha((dados: RLJ_Ficha2) => {
//                 return dados.detalhes.idClasse === 4;
//             })
//         }).adicionarModificadores([{ nome: 'Constituição Paranormal', idDuracao: 5, quantidadeDuracaoMaxima: 1, dadosEfeitos: [{ idLinhaEfeito: 62, idTipoEfeito: 4, dadosValoresEfeitos: { valorBonusAdicional: pericias.find(pericia => pericia.refPericia.id === 16)?.valorNivelPatente } }], dadosComportamentos: { dadosComportamentoPassivo: [] } }]),

//         new HabilidadePassiva({
//             dadosGenericosHabilidade: { nome: 'Mente Corrompida', descricao: 'Aumenta +5 OCUL' }, fonteHabilidade: { fonte: 'Habilidade Especial', tipo: 'Classe' }, requisitoFicha: new RequisitoFicha((dados: RLJ_Ficha2) => {
//                 return dados.detalhes.idClasse === 4;
//             })
