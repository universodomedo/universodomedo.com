...
export class Item {
    ...
    public comportamentoEmpunhavel: ComportamentoEmpunhavel;
    public comportamentoVestivel: ComportamentoVestivel;
    ...
    get itemPodeSerSacado(): boolean { return this.comportamentoEmpunhavel.podeSerEmpunhado && !this.comportamentoEmpunhavel.estaEmpunhado; }
    get itemPodeSerGuardado(): boolean { return this.comportamentoEmpunhavel.estaEmpunhado; }
    get itemPodeSerVestido(): boolean { return this.comportamentoVestivel.podeSerVestido && this.comportamentoEmpunhavel.estaEmpunhado && !this.comportamentoVestivel.estaVestido; }
    get itemPodeSerDesvestido(): boolean { return this.comportamentoVestivel.estaVestido; }
    ...
    removeDoInventario(): void {
        ...
        this.comportamentoEmpunhavel.refExtremidade?.limpa();
    }
