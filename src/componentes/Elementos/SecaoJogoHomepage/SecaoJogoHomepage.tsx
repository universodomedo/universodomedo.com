    ...
    return (
        <div className={styles.recipiente_secao_jogo}>
            <div className={styles.recipiente_artigos}>
                ...
                <div className={styles.recipiente_artigo_carrossel}></div>
