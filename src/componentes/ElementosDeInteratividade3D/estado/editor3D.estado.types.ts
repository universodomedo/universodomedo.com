...
export interface ProjetoAbertoEditor3D {
    readonly id: number;
    readonly nome: string;
};

export interface AbaProjeto3DEditor3D {
    readonly id: string;
    readonly nome: string;
    readonly projetoAberto: ProjetoAbertoEditor3D | null;
    readonly cenaCanonica: CenaCanonicaEditor3D;
    readonly assinaturaCenaSalva: string | null;
...
export interface Editor3DState {
    ...
    readonly ocultacoesGuiasCenaTemporaria: number;
...
export interface Editor3DAcoes {
    ...
    iniciaOcultacaoGuiasCenaTemporaria: () => void;
    finalizaOcultacaoGuiasCenaTemporaria: () => void;
    ...
    trocaTipoMalhaEmCriacao: (tipoMalha: TipoMalhaEditor3D) => void;
    criaPresetObjetoCena: (preset: PresetObjetoCenaEditor3D) => void;
    ...
    limpaCena: () => void;
    defineProjetoAberto: (projetoAberto: ProjetoAbertoEditor3D | null) => void;
    carregaCenaCanonica: (cena: CenaCanonicaEditor3D) => void;
    carregaProjetoCanonico: (projeto: Projeto3DMinimoPersistido) => void;
    criaNovaAbaProjeto3D: () => void;
    trocaAbaProjeto3D: (idAba: string) => void;
    fechaAbaProjeto3D: (idAba: string) => void;
    carregaProjetoCanonicoEmAba: (projeto: Projeto3DMinimoPersistido) => void;
    marcaAbaProjeto3DSalva: (projetoAberto: ProjetoAbertoEditor3D) => void;
