...
export const lista_geral_habilidades = (): Habilidade[] => {
    ...
    // );
        ...
        // new HabilidadePassiva('Teste Movimento Frenético 1', 'Aumenta seu Deslocamento em +3', new RequisitoFicha((personagem: Personagem) => { return true})).adicionarModificadores([{ nome: 'Movimento Frenético', idDuracao: 3, quantidadeDuracaoMaxima: 1, dadosEfeitos: [{ idLinhaEfeito:53, idTipoEfeito: 4, dadosValoresEfeitos: { valorBaseAdicional: 0, valorMultiplicadorAdicional: 1   , valorBonusAdicional: 0 } }], dadosComportamentos: { dadosComportamentoPassivo: [false] } }]),
        // new HabilidadePassiva('Teste Movimento Frenético 2', 'Aumenta seu Deslocamento em +3', new RequisitoFicha((personagem: Personagem) => { return true})).adicionarModificadores([{ nome: 'Movimento Frenético', idDuracao: 3, quantidadeDuracaoMaxima: 1, dadosEfeitos: [{ idLinhaEfeito:53, idTipoEfeito: 4, dadosValoresEfeitos: { valorBaseAdicional: 0, valorMultiplicadorAdicional: 1   , valorBonusAdicional: 3 } }], dadosComportamentos: { dadosComportamentoPassivo: [false] } }]),
        // new HabilidadePassiva('Teste Movimento Frenético 3', 'Aumenta seu Deslocamento em +3', new RequisitoFicha((personagem: Personagem) => { return true})).adicionarModificadores([{ nome: 'Movimento Frenético', idDuracao: 3, quantidadeDuracaoMaxima: 1, dadosEfeitos: [{ idLinhaEfeito:53, idTipoEfeito: 4, dadosValoresEfeitos: { valorBaseAdicional: 2, valorMultiplicadorAdicional: 1   , valorBonusAdicional: 2 } }], dadosComportamentos: { dadosComportamentoPassivo: [false] } }]),
        // new HabilidadePassiva('Teste Movimento Frenético 4', 'Aumenta seu Deslocamento em +3', new RequisitoFicha((personagem: Personagem) => { return true})).adicionarModificadores([{ nome: 'Movimento Frenético', idDuracao: 3, quantidadeDuracaoMaxima: 1, dadosEfeitos: [{ idLinhaEfeito:53, idTipoEfeito: 4, dadosValoresEfeitos: { valorBaseAdicional: 3, valorMultiplicadorAdicional: 0   , valorBonusAdicional: 5 } }], dadosComportamentos: { dadosComportamentoPassivo: [false] } }]),
        // new HabilidadePassiva('Teste Movimento Frenético 5', 'Aumenta seu Deslocamento em +3', new RequisitoFicha((personagem: Personagem) => { return true})).adicionarModificadores([{ nome: 'Movimento Frenético', idDuracao: 3, quantidadeDuracaoMaxima: 1, dadosEfeitos: [{ idLinhaEfeito:53, idTipoEfeito: 4, dadosValoresEfeitos: { valorBaseAdicional: 0, valorMultiplicadorAdicional: 1.5 , valorBonusAdicional: 0 } }], dadosComportamentos: { dadosComportamentoPassivo: [false] } }]),
        // new HabilidadePassiva('Teste Movimento Frenético 6', 'Aumenta seu Deslocamento em +3', new RequisitoFicha((personagem: Personagem) => { return true})).adicionarModificadores([{ nome: 'Movimento Frenético', idDuracao: 3, quantidadeDuracaoMaxima: 1, dadosEfeitos: [{ idLinhaEfeito:53, idTipoEfeito: 4, dadosValoresEfeitos: { valorBaseAdicional: 0, valorMultiplicadorAdicional: 1.5 , valorBonusAdicional: 2 } }], dadosComportamentos: { dadosComportamentoPassivo: [false] } }]),
        // new HabilidadePassiva('Teste Movimento Frenético 7', 'Aumenta seu Deslocamento em +3', new RequisitoFicha((personagem: Personagem) => { return true})).adicionarModificadores([{ nome: 'Movimento Frenético', idDuracao: 3, quantidadeDuracaoMaxima: 1, dadosEfeitos: [{ idLinhaEfeito:53, idTipoEfeito: 4, dadosValoresEfeitos: { valorBaseAdicional: 2, valorMultiplicadorAdicional: 1.5 , valorBonusAdicional: 0 } }], dadosComportamentos: { dadosComportamentoPassivo: [false] } }]),
        // new HabilidadePassiva('Teste Movimento Frenético 8', 'Aumenta seu Deslocamento em +3', new RequisitoFicha((personagem: Personagem) => { return true})).adicionarModificadores([{ nome: 'Movimento Frenético', idDuracao: 3, quantidadeDuracaoMaxima: 1, dadosEfeitos: [{ idLinhaEfeito:53, idTipoEfeito: 4, dadosValoresEfeitos: { valorBaseAdicional: 2, valorMultiplicadorAdicional: 1.1 , valorBonusAdicional: 0 } }], dadosComportamentos: { dadosComportamentoPassivo: [false] } }]),
        new HabilidadePassiva('Teste Movimento Frenético 9', 'Aumenta seu Deslocamento em +3', new RequisitoFicha((personagem: Personagem) => { return true})).adicionarModificadores([{ nome: 'Movimento Frenético1', idDuracao: 3, quantidadeDuracaoMaxima: 1, dadosEfeitos: [{ idLinhaEfeito:53, idTipoEfeito: 4, dadosValoresEfeitos: { valorBaseAdicional: 2, valorMultiplicadorAdicional: 1.25, valorBonusAdicional: 1 } }], dadosComportamentos: { dadosComportamentoPassivo: [false] } }]),
        new HabilidadePassiva('Teste Movimento Frenético 10', 'Aumenta seu Deslocamento em +3', new RequisitoFicha((personagem: Personagem) => { return true})).adicionarModificadores([{ nome: 'Movimento Frenético2', idDuracao: 3, quantidadeDuracaoMaxima: 1, dadosEfeitos: [{ idLinhaEfeito:53, idTipoEfeito: 4, dadosValoresEfeitos: { valorBaseAdicional: 1, valorMultiplicadorAdicional: 0.9 , valorBonusAdicional: 4 } }], dadosComportamentos: { dadosComportamentoPassivo: [false] } }]),
