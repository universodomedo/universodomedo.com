...
import { PreviewRuntimePartida } from 'Componentes/ElementosDeJogo/PreviewRuntimePartida/PreviewRuntimePartida';
...
export default function SPA__PaginaGameDesignerConfiguracaoPartida__Edicao() {
    ...
    return (
        <div className={styles.painel}>
            ...
            {aba === 'previewRuntime' && (carregando ? <p className={styles.estado}>{carregando}…</p> : configuracaoInicial === null ? <p className={styles.estado}>Runtime ainda não configurado.</p> : <PreviewRuntimePartida configuracao={configuracaoInicial} />)}
