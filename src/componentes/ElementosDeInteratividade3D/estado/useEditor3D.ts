...
export function useEditor3D(estadoInicial?: Editor3DState): Editor3DModelo {
    ...
    const acoes = useMemo<Editor3DAcoes>(() => ({
        ...
        defineProjetoAberto: projetoAberto => dispatch({ tipo: 'DEFINE_PROJETO_ABERTO', projetoAberto }),
        carregaCenaCanonica: cena => dispatch({ tipo: 'CARREGA_CENA_CANONICA', cena }),
        carregaProjetoCanonico: projeto => dispatch({ tipo: 'CARREGA_PROJETO_CANONICO', projeto }),
        criaNovaAbaProjeto3D: () => dispatch({ tipo: 'CRIA_NOVA_ABA_PROJETO_3D' }),
        trocaAbaProjeto3D: idAba => dispatch({ tipo: 'TROCA_ABA_PROJETO_3D', idAba }),
        fechaAbaProjeto3D: idAba => dispatch({ tipo: 'FECHA_ABA_PROJETO_3D', idAba }),
        carregaProjetoCanonicoEmAba: projeto => dispatch({ tipo: 'CARREGA_PROJETO_CANONICO_EM_ABA', projeto }),
        marcaAbaProjeto3DSalva: projetoAberto => dispatch({ tipo: 'MARCA_ABA_PROJETO_3D_SALVA', projetoAberto }),
