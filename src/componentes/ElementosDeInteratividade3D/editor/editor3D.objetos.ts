...
export function criaObjetoCenaEditor3D(id: number, tipo: TipoMalhaEditor3D, quantidadeVertices: number): ObjetoCenaEditor3D {
    ...
    return { id: `malha-${id}`, nome: `${definicao.nome} ${id}`, tipo, quantidadeVertices: quantidadeVerticesFinal, posicao: [0, 0, 0], rotacao: [0, 0, 0], escala: [1, 1, 1], matrizBase: criaMatrizIdentidadeEditor3D(), malhaEditavel: null, versaoGeometria: 0, corBase: definicao.corBase, corLuz: definicao.corLuz, shader: 'PADRAO' };
};
