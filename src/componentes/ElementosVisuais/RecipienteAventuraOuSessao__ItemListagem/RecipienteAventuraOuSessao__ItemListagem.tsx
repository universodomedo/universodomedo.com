...
export default function RecipienteAventuraOuSessao__ItemListagem({ destino, imagem, detalhePrincipal, detalheSecundario }: { destino: DestinoInput; imagem: string; detalhePrincipal?: string; detalheSecundario?: string; }) {
    return (
