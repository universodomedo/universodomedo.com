...
singletonHelper.buffs = [
    new BuffRef(1, "Agilidade"), 
    new BuffRef(2, "Força"), 
    new BuffRef(3, "Inteligência"), 
    new BuffRef(4, "Presença"), 
    new BuffRef(5, "Vigor"), 
    new BuffRef(6, "Acrobacia"), 
    new BuffRef(7, "Adestramento"), 
    new BuffRef(8, "Artes"), 
    new BuffRef(9, "Atletismo"), 
    new BuffRef(10, "Atualidades"), 
    new BuffRef(11, "Ciências"), 
    new BuffRef(12, "Crime"), 
    new BuffRef(13, "Diplomacia"), 
    new BuffRef(14, "Enganação"), 
    new BuffRef(15, "Engenharia"), 
    new BuffRef(16, "Fortitude"), 
    new BuffRef(17, "Furtividade"), 
    new BuffRef(18, "Iniciativa"), 
    new BuffRef(19, "Intimidação"), 
    new BuffRef(20, "Intuição"), 
    new BuffRef(21, "Investigação"), 
    new BuffRef(22, "Luta"), 
    new BuffRef(23, "Medicina"), 
    new BuffRef(24, "Ocultismo"), 
    new BuffRef(25, "Percepção"), 
    new BuffRef(26, "Pontaria"), 
    new BuffRef(27, "Reflexo"), 
    new BuffRef(28, "Sobrevivência"), 
    new BuffRef(29, "Tatica"), 
    new BuffRef(30, "Tecnologia"), 
    new BuffRef(31, "Vontade"), 
    new BuffRef(32, "R.D. Vital"), 
    new BuffRef(33, "R.D. Mundano"), 
    new BuffRef(34, "R.D. Concussivo"), 
    new BuffRef(35, "R.D. Cortante"), 
    new BuffRef(36, "R.D. Perfurante"), 
    new BuffRef(37, "R.D. Natural"), 
    new BuffRef(38, "R.D. Elétrico"), 
    new BuffRef(39, "R.D. Fogo"), 
    new BuffRef(40, "R.D. Frio"), 
    new BuffRef(41, "R.D. Químico"), 
    new BuffRef(42, "R.D. Elemental"), 
    new BuffRef(43, "R.D. Conhecimento"), 
    new BuffRef(44, "R.D. Sangue"), 
    new BuffRef(45, "R.D. Energia"), 
    new BuffRef(46, "R.D. Morte"), 
    new BuffRef(47, "R.D. Medo"), 
    new BuffRef(48, "R.D. Mental"), 
    new BuffRef(49, "R.D. Debilitante"), 
    new BuffRef(50, "Dano"), 
    new BuffRef(51, "Variância"), 
    new BuffRef(52, 'Permeabilidade'),
    new BuffRef(53, 'Capacidade de Carga')
];
