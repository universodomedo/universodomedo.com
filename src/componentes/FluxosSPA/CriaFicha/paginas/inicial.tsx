...
export default function SPA_PaginaJogadorCriarFicha_Inicial() {
    const { navegarPara, possuiFicha, nomeFicha, setNomeFicha, descricaoFicha, setDescricaoFicha, modoCriacao, selecionarModoCriacao, podeComecarCriacao } = useContextoPaginaJogadorCriaFicha();
        ...
        <div className={styles.recipiente_criar_ficha_conteudo}>
            <div className={styles.recipiente_criar_ficha_conteudo_principal}>
                <div className={styles.recipiente_botoes_criar_ficha}>
                    <BotaoCriacao bloqueadoTemporariamente={possuiFicha ? true : undefined} arquivoImagem={'BOTAO_CRIACAO__FICHA__IMAGEM__CRIA'} texto={'Nova Ficha'} ativo={modoCriacao === 'NOVA_FICHA'} onClick={() => selecionarModoCriacao('NOVA_FICHA')} />
