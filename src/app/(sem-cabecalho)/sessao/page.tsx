...
import { obtemDadosSessaoEmAndamento } from 'Uteis/ApiConsumer/ConsumerMiddleware.tsx';
...
export default function PaginaSessao() {
    ...
    async function obtemSessaoEmAndamento() {
        const respostaDadosSessao = await obtemDadosSessaoEmAndamento();

        if (respostaDadosSessao.sucesso && respostaDadosSessao.dados) setSessaoEmAndamento(respostaDadosSessao.dados);
    };
