...
import { Elemento, NivelRitual, CirculoRitual, Alcance, FormatoAlcance, Duracao, TipoExecucao, TipoAcao, TipoAlvo, TipoDano, CirculoNivelRitual, TipoEstatisticaDanificavel, TipoEstatisticaBuffavel, Atributo, Pericia, PatentePericia, NivelComponente, TipoRequisito, Habilidade, RequisitoFicha, Classe, Nivel, TipoItem, LinhaEfeito, TipoEfeito, TipoProficiencia, NivelProficiencia } from 'Classes/ClassesTipos/index.ts';
// #endregion
...
singletonHelper.classes = [
    new Classe(1, 'Mundano', ''),
    new Classe(2, 'Combatente', 'Combatentes tem os melhores Ganhos de Estatísticas, além de receber Pontos de Atributos Bônus durante seu crescimento'),
    new Classe(3, 'Especialista', 'Especialistas tem os melhores ganhos de Aprimoramento de Patente de Perícia, acompanhado do maior número de Habilidades de Perícias'),
    new Classe(4, 'Ocultista', 'Ocultistas tem o melhor Ganho de Pontos de Sanidade, além de receber vários Rituais Bônus')
];
