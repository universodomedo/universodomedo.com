// #region Imports
import { classeComArgumentos, adicionarAcoesUtil, Acao, RequisitoFicha, Personagem, CustoExecucao, FiltroProps, FiltroPropsItems, EmbrulhoComportamentoHabilidade, Modificador, adicionarModificadoresUtil, OpcoesFiltro, OpcoesFiltrosCategorizadas, Pericia, PatentePericia, Proficiencia, DadosGenericosHabilidade, DadosGenericosHabilidadeParams } from 'Types/classes/index.ts';
...
export const lista_geral_habilidades = (): Habilidade[] => {
    return [
        ...
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Ação Rápida', descricao: 'Você recebe uma Ação de Movimento Extra' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 7, idPatente: 2 }, }).adicionarAcoes([
            {
                props: [{ nome: 'Ação Rápida', idTipoAcao: 1, }, {
                    dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 2, idPericia: 7 }, dadosDificuldadeDinamica: { dificuldadeInicial: 10, modificadorDificuldadeInicial: 3, listaModificadoresDificuldade: [2] } },
                }],
                config: (acao) => {
        ...
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Arte Acolhedora', descricao: 'Você realiza um Teste ARTE para Acalmar' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 10, idPatente: 3 }, }).adicionarAcoes([{ props: [{ nome: 'Arte Acolhedora', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 10 } } }], }]),
        ...
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Domínio Científico', descricao: 'Você utiliza materiais e ferramentas para confecção de uma substância ciêntifica' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 12, idPatente: 2 }, }).adicionarAcoes([{ props: [{ nome: 'Domínio Científico', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 12 } } }], }]),
        ...
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Confecção', descricao: 'Cria e troca características de objetos' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 13, idPatente: 2 }, }).adicionarAcoes([{ props: [{ nome: 'Confecção', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 13 } } }], }]),
        ...
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Desmantelar', descricao: 'Destroi itens e recupera seus materiais de construção' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 13, idPatente: 3 }, }).adicionarAcoes([{ props: [{ nome: 'Desmantelar', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 13 } } }], }]),
        ...
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Na Pista Certa', descricao: 'Você recebe as informações de sua investigação e uma dica que o leva para a próxima informação, se houver' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 14, idPatente: 4 }, }).adicionarAcoes([{ props: [{ nome: 'Na Pista Certa', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 14 } } }], }]),

        // MEDI //

        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Estancar', descricao: 'Diminui a Dificuldade de Primeiro Socorros de um alvo Morrendo' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 15, idPatente: 1 }, }).adicionarAcoes([{ props: [{ nome: 'Estancar', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 15 } } }], }]),
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Primeiros Socorros', descricao: 'Você recupera 1 P.V. do alvo e retira o estado Morrendo' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 15, idPatente: 2 }, }).adicionarAcoes([{ props: [{ nome: 'Primeiros Socorros', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 15 } } }], }]),
        ...
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Identificar Símbolo', descricao: 'Você recebe informações sobre um Símbolo' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 16, idPatente: 2 }, }).adicionarAcoes([{ props: [{ nome: 'Identificar Símbolo', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 16 } } }], }]),
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Memória do Outro Lado', descricao: 'Você recebe informações sobre uma Criatura' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 16, idPatente: 2 }, }).adicionarAcoes([{ props: [{ nome: 'Memória do Outro Lado', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 16 } } }], }]),
        ...
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Sentir Membrana', descricao: 'Você recebe informações sobre a Membrana do Ambiente' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 16, idPatente: 4 }, }).adicionarAcoes([{ props: [{ nome: 'Sentir Membrana', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 16 } } }], }]),
        ...
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Meios de Sobreviver', descricao: 'Você aplica conhecimentos naturais, como comportamento animal, seguir pegadas, entre outros' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 17, idPatente: 1 }, }).adicionarAcoes([{ props: [{ nome: 'Meios de Sobreviver', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 17 } } }], }]),
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Improvisar Ferramenta', descricao: 'Você temporariamente cria, concerta ou improvisa uma ferramenta ou situação para um problema. A qualidade e efetividade do resultado nunca será tão alto quanto de um item especifico para a situação' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 17, idPatente: 2 }, }).adicionarAcoes([{ props: [{ nome: 'Improvisar Ferramenta', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 17 } } }], }]),
        ...
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Armar Armadilha', descricao: 'Você constroi uma armadilha improvisada na sua posição atual. Quando um alvo despercebido que falhar um teste PERC se mover por cima da armadilha, fica imóvel e precisa de uma ação completa para se soltar' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 17, idPatente: 3 }, }).adicionarAcoes([{ props: [{ nome: 'Armar Armadilha', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 17 } } }], }]),
        ...
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Manusear Maquinário', descricao: 'Você utiliza de um sistema digital' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 19, idPatente: 1 }, }).adicionarAcoes([{ props: [{ nome: 'Manusear Maquinário', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 19 } } }], }]),
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Hacker', descricao: 'Você realiza um teste para invadir um sistema digital. Se você não tiver sucesso, você ao menos sabe a DT do teste' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 19, idPatente: 2 }, }).adicionarAcoes([{ props: [{ nome: 'Hacker', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 19 } } }], }]),
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Improvisar Equipamentos', descricao: 'Você monta um sistema digital temporario' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 19, idPatente: 3 }, }).adicionarAcoes([{ props: [{ nome: 'Improvisar Equipamentos', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 19 } } }], }]),
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Preparar Mecanismo', descricao: 'Você monta um mecanismo automático' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 19, idPatente: 4 }, }).adicionarAcoes([{ props: [{ nome: 'Preparar Mecanismo', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 3, idPericia: 19 } } }], }]),

        // DIPL //

        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Melhorar Relacionamento', descricao: 'Você melhora seu nível de relacionamento com esse ser' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 20, idPatente: 1 }, }).adicionarAcoes([{ props: [{ nome: 'Melhorar Relacionamento', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 4, idPericia: 20 } } }], }]),
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Acalmar', descricao: 'Você retira um Ser de Enlouquecendo' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 20, idPatente: 2 }, }).adicionarAcoes([{ props: [{ nome: 'Acalmar', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 44, idPericia: 20 } } }], }]),
        ...
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Esconder Informação', descricao: 'Você realiza ações ou redige informação que não condizem com a verdade' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 21, idPatente: 1 }, }).adicionarAcoes([{ props: [{ nome: 'Esconder Informação', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 4, idPericia: 21 } } }], }]),
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Disfarce Realista', descricao: 'Você estuda e replica um padrão de uniforme ou identificação' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 21, idPatente: 2 }, }).adicionarAcoes([{ props: [{ nome: 'Disfarce Realista', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 44, idPericia: 21 } } }], }]),
        ...
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Analisar Arredores', descricao: 'Você recebe informações sobre algo na qual tenha linha de visão' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 24, idPatente: 1 }, }).adicionarAcoes([{ props: [{ nome: 'Analisar Arredores', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 4, idPericia: 24 } } }], }]),
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Analisar Comportamento', descricao: 'Você recebe informações sobre um Ser ou uma Ação desse Ser' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 24, idPatente: 2 }, }).adicionarAcoes([{ props: [{ nome: 'Analisar Comportamento', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 4, idPericia: 24 } } }], }]),
        ...
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Estabilidade Mental', descricao: 'Você permanece com 1 P.S.' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 25, idPatente: 4 }, }).adicionarAcoes([{ props: [{ nome: 'Estabilidade Mental', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 4, idPericia: 25 } } }], }]),
        ...
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Aprimorar Resistência', descricao: 'Você recebe R.D. a um Tipo de Dano Mundano até o início do seu próximo Turno' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 26, idPatente: 2 }, }),
        ...
        new HabilidadeAtiva({ dadosGenericosHabilidade: { nome: 'Negar a Morte', descricao: 'Você permanece com 1 P.V.' }, fonteHabilidade: { fonte: 'Habilidade de Perícia', idPericia: 26, idPatente: 4 }, }).adicionarAcoes([{ props: [{ nome: 'Negar a Morte', idTipoAcao: 1 }, { dadosComportamentoDificuldadeAcao: { dadosTeste: { idAtributo: 5, idPericia: 26 } } }], }]),
