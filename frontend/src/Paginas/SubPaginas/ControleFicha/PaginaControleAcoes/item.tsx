...
import { GastaCustoProps, IAcaoService } from 'Classes/ClassesTipos/index.ts';
...
const page = ({ acao }: { acao: IAcaoService }) => {
...
const Icone = ({ acao, mostrarEtiquetas }: { acao: IAcaoService, mostrarEtiquetas: boolean }) => {
    return (
...
const ConteudoExecucao = ({ acao, fecharModal }: { acao: IAcaoService, fecharModal: () => void }) => {
...
const ConteudoDetalhes = ({ acao }: { acao: IAcaoService }) => {
