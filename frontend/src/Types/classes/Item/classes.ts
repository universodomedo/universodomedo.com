// #region Imports
import { Comportamentos, Acao, adicionarAcoesUtil, adicionarBuffsUtil, Buff, FiltroProps, FiltroPropsItems, OpcaoFiltro, OpcoesFiltro, DadosComportamentos, DadosGenericosItem } from 'Types/classes/index.ts';
...
export class Item {
    ...
    public comportamentos: Comportamentos = new Comportamentos();
