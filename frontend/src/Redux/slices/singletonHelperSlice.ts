...
singletonHelper.pericias = [
    ...
    new Pericia(5, 26, 1, 'Pontaria', 'PONT', 'Experiência em combater e utilizar de armas a distância.'),
    ...
    new Pericia(8, 22, 2, 'Luta', 'LUTA', 'Experiência em combater e utilizar de armas corpo-a-corpo.'),
