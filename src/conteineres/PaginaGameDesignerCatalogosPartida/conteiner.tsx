...
function resolveSaida(props: PropsConteiner__PaginaGameDesignerCatalogosPartida): SaidaConteiner {
    ...
    if (props.catalogoEmEdicao !== null) return criaSaidaConteiner(Contexto__PaginaGameDesignerCatalogosPartida__Edicao__Provider, { catalogo: props.catalogoEmEdicao, todasPartidas: props.partidas, salvando: props.salvando, salvarCatalogo: props.salvarCatalogo, deletarCatalogo: props.deletarCatalogo, adicionarPartida: props.adicionarPartida, removerPartida: props.removerPartida, alternarExibicao: props.alternarExibicao, reordenarPartidas: props.reordenarPartidas, adicionarRequisitoCatalogo: props.adicionarRequisitoCatalogo, removerRequisitoAcesso: props.removerRequisitoAcesso, adicionarRequisitoSubcatalogo: props.adicionarRequisitoSubcatalogo, removerRequisitoAcessoSubcatalogo: props.removerRequisitoAcessoSubcatalogo, criarSubcatalogo: props.criarSubcatalogo, salvarSubcatalogo: props.salvarSubcatalogo, deletarSubcatalogo: props.deletarSubcatalogo, definirSubcatalogoPartida: props.definirSubcatalogoPartida, voltaParaListagem: props.voltaParaListagem });
