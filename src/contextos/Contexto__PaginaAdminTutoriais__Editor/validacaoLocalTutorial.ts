...
export function blocoLocalEhValido(bloco: BlocoLocalTutorial): boolean { return bloco.tipo === 'texto' ? bloco.markdown.trim().length > 0 : bloco.idArquivoTipadoArte !== null; };
