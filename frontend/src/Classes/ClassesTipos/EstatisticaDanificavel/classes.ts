export type EstatisticaDanificavelModelo = {
    id: number;
    nome: string;
    cor: string;
    descricao: string;
...
export type EstatisticaDanificavel = EstatisticaDanificavelModelo & {
    readonly nomeAbreviado: string;
};

export type EstatisticaDanificavelPersonagem = {
    valorAtual: number;
    valorMaximo: number;
...
export type DadosEstatisticaDanificavelPersonagem = Omit<EstatisticaDanificavelPersonagem, 'alterarValorAtual' | 'alterarValorMaximo' | 'refEstatisticaDanificavel'> & {
    idEstatisticaDanificavel: number;
};
