...
export default function desenhaEventoNaLinhaDoTempo(rootElement: HTMLDivElement, windowSize: { width: number; height: number }, timelineEvents: { color: string; ts: number; title: string; }[]) {
