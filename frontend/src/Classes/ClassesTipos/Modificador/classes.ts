// #region Imports
import { Acao, ComportamentosModificador, DadosComportamentosModificador, Duracao, Efeito, FiltroProps, FiltroPropsItems, HabilidadePassiva, Item, OpcoesFiltro, pluralize } from 'Classes/ClassesTipos/index.ts';
