...
function resolveSaida(props: PropsConteiner__PaginaGameDesignerSeres): SaidaConteiner {
    ...
    if (props.estadoFluxo === 'DETALHE') return criaSaidaConteiner(Contexto__PaginaGameDesignerSeres__Detalhe__Provider, { idSerSelecionado: props.idSerSelecionado, voltaParaListagem: props.voltaParaListagem });
