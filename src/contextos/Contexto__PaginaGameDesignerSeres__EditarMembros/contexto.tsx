...
import { alternaCapacidadeMembroEditor, atualizaNomeMembroEditor, membroEditorVazio, membrosEditorDePersistidos, membrosEditorSaoValidos, montaInputMembrosEditor, obtemMensagemValidacaoMembrosEditor, type MembroEditor } from './membrosSerJogavelEditor';
...
export const Contexto__PaginaGameDesignerSeres__EditarMembros__Provider = ({ fkSerId, voltar }: PropsProvider) => {
    ...
    useEffect(() => {
        ...
        async function carrega(): Promise<void> {
            ...
            try {
                ...
                const membrosCarregados = membrosEditorDePersistidos(dados.membros, proximoIdLocal);
    ...
    return (
        <Contexto__PaginaGameDesignerSeres__EditarMembros.Provider value={{ membros, capacidadesInatas, carregando, salvando, podeSalvar, mensagemValidacao, adicionaMembro, removeMembro, atualizaNomeMembro, alternaCapacidadeMembro, salvar, voltar }}>
