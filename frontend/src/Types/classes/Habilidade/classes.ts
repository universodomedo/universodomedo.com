...
export const lista_geral_habilidades = (): Habilidade[] => {
    ...
    // );
        ...
        // new HabilidadePassiva('Teste Movimento Frenético 10', 'Aumenta seu Deslocamento em +3', new RequisitoFicha((personagem: Personagem) => { return true})).adicionarModificadores({ nome: 'Movimento Frenético', idDuracao: 3, quantidadeDuracaoMaxima: 1, dadosEfeitos: [{ idLinhaEfeito:53, idTipoEfeito: 4, dadosValoresEfeitos: { valorBaseExtra: 1, valorMultiplicador: 0.9 , valorAdicional: 4 } }], dadosComportamentos: { dadosComportamentoPassivo: [false] } }),
