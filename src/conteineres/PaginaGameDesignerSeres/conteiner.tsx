...
import { Contexto__PaginaGameDesignerSeres__Estrutura__Provider } from 'Contextos/Contexto__PaginaGameDesignerSeres__Estrutura/contexto';
...
function resolveSaida(props: PropsConteiner__PaginaGameDesignerSeres): SaidaConteiner {
    ...
    if (props.estadoFluxo === 'ESTRUTURA' && props.idSerEstrutura !== null) return criaSaidaConteiner(Contexto__PaginaGameDesignerSeres__Estrutura__Provider, { idSer: props.idSerEstrutura, voltar: props.voltaParaListagem });

    return criaSaidaConteiner(Contexto__PaginaGameDesignerSeres__Listagem__Provider, { listagemSeres: props.listagemSeres, iniciaCadastro: props.iniciaCadastro, abreEstrutura: props.abreEstrutura });
};
