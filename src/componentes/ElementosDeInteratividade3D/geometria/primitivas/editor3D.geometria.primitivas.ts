...
import { criaGeometriaMalhaEditavelEditor3D } from '../editor3D.geometria.malhaEditavel';
...
export function criaGeometriaObjetoEditor3D(objeto: ObjetoCenaEditor3D): GeometriaEditor3D {
    if (objeto.malhaEditavel !== null) return criaGeometriaMalhaEditavelEditor3D(objeto.malhaEditavel);
