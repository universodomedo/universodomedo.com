...
import { GraphqlLeituras, MIXER_CANAL_CONTROLAVEL_2 } from 'types-nora-api';
...
// Caso 5 (controlador): superficie de controle do canal 2. Comanda AO VIVO qual MusicaConfigurada toca para os
...
export function Componente_ConteudoPrototipo() {
    const { selecao, definirMusica, erro } = useMixerCanal(MIXER_CANAL_CONTROLAVEL_2);
