...
import { DescricaoPartida } from 'Conteineres/PaginaPartidas/paginas/SPA__PaginaPartidas/DescricaoPartida';

// Detalhe da Partida selecionada: ocupa 100% da altura ao lado do Orbital.
// Topo = Arte de Capa. Corpo = bloco de 2 colunas (título + descrição | meta). Rodapé fixo = botão Jogar.
            ...
            <div className={styles.detalhe_corpo}>
                <div className={styles.info}>
                    <div className={styles.info_principal}>
                        ...
                        <DescricaoPartida key={partida.id} idPartida={partida.id} />
                    </div>
