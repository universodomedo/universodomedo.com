        ...
        <div className={styles.recipiente_pagina_de_jogo}>
            <div className={styles.recipiente__pagina_de_jogo__superior}>
                <div className={styles.recipiente_container_tela_de_jogo__em_pagina_de_jogo}>
                    <TelaDeJogo codigoSala={objetoEmJogo.objetoInicialSala.codigoSalaDeJogo} />
                </div>
            ...
            <SwiperDireita>
                <ConteudoFichaDeJogo JDadosFichaEmJogo={J_fichaAtualizada} desativarAcoes={false} exibirHabilidadesRuntime exibirAcoesRuntime exibirModificadoresRuntime codigoRecuperarFichaRuntime={`${objetoEmJogo.objetoInicialSala.codigoSalaDeJogo}_${objetoEmJogo.objetoInicialSala.idFicha}`} />
            </SwiperDireita>
        </div>
    );
};
