    ...
    return (
        <ConteudoForm>
            ...
            <ConteudoForm.AreaBotoes>
                <button type="button" onClick={configurarRuntime}>Configurar Runtime</button>
                <button type="button" onClick={() => void configurarDetalhes()} disabled={salvando}>Configurar Detalhes</button>
                <button type="button" data-variante="perigo" onClick={() => void deletar()} disabled={salvando}>Deletar Partida</button>
            </ConteudoForm.AreaBotoes>
        </ConteudoForm>
    );
};
