// #region Imports
import { adicionarAcoesUtil, Acao, DetalhesComponente, FiltroProps, FiltroPropsItems, OpcoesFiltro, PaletaCores, ComportamentoGeral } from 'Types/classes/index.ts';
...
export class Ritual {
    ...
    constructor(
        ...
        this.comportamentoGeral = new ComportamentoGeral({ detalhesComponente: new DetalhesComponente(this._idElemento, this.refNivelComponente.id) });
    }
