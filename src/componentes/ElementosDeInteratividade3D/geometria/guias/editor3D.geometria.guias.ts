...
import { criaGuiaEixoCompletoEditor3D, criaGuiaEixoNegativoEditor3D, criaGuiaEixoPositivoEditor3D } from './editor3D.geometria.eixos';
...
export function criaGeometriasGizmoEixosEditor3D(): GuiaEditor3D[] {
    return [
        criaGuiaEixoNegativoEditor3D('X', 0.9),
        criaGuiaEixoNegativoEditor3D('Y', 0.9),
        criaGuiaEixoNegativoEditor3D('Z', 0.9),
